...
Papers of record: [The Afferent Gnosis Model: Self-Knowledge Without Self-Control](https://doi.org/10.5281/zenodo.21613153) · [The Vektorgeist Method (VGM): Sovereign, Local, Self-Understanding AI](https://doi.org/10.5281/zenodo.21613155) · [Hodos Diastema — Comparing Processes as Curves of Distributions](https://doi.org/10.5281/zenodo.21612829) · [Learning Without Weights](https://doi.org/10.5281/zenodo.21612831) · [Beyond Weights: a Fixed Transmission Architecture for Learning Through Signal and Memory](https://doi.org/10.5281/zenodo.21850560) · [Testing a Conditional Claim About Trajectories: a Control Blind by Construction, and Five Ways It Was Silently Wrong](https://doi.org/10.5281/zenodo.21850664) · [The Hodos Family: Equations Generated by a Relational Premise](https://doi.org/10.5281/zenodo.21850666) · [A Clock Made of Relations: Intrinsic Duration for a System of Interacting Parts](https://doi.org/10.5281/zenodo.21861429) · [The Law of Two: Why a Relational Ontology Entails Exactly Two](https://doi.org/10.5281/zenodo.21879204) · [The Hodos Hypothesis](https://doi.org/10.5281/zenodo.21912354)
...
|---|---:|---|
| Active | 31 | Survives the controls it was tested against; currently believed. |
| Provisional | 4 | Measured, but on one task or at small scale; not yet replicated. |
| Negative | 16 | Tested and did NOT hold. Reported because a negative is a result. |
| Retracted | 8 | We claimed it, then our own measurement refuted it. Original wording kept visible. Each retraction is labelled by WHAT it withdrew: a positive claim (we said it worked) or a negative one (we said it did not work, or that it was a limit of the method). |
| **Total** | **59** | |

**16 negative results and 8 retractions are in here on purpose.** A retraction keeps its original wording visible with the reason it was wrong next to it. `check.py` fails the build if a retraction carries no explanation — that would be a deletion, not a retraction.
...
- **[58] The 'unexplained' detection band was the plant's own fault: |sin| halves the period, and the corrected rule is exact on 58 of 58 cells** `[foundations]` — rung 2, 2026-08-12  
...
- **[57] Chronos is oriented, and nothing had ever checked the direction: 63 of 66 relations read differently reversed - and the headline survives either way** `[foundations]` — rung 3, 2026-08-12  
...
- **[55] The shipped warp was not a distance: a thing's distance from itself was negative, and grew with its length** `[foundations]` — rung 3, 2026-08-11  
...
- **[54] A clock made of relations, pointed at 1,701 supernovae - and it does not tell cosmic time** `[foundations]` — rung 3, 2026-08-10  
  Chronos and Diastema run over every pairwise relation of the twelve measured columns of the Pantheon+/SH0ES catalogue: 12 parts, 66 relations, 85 dials, packaged as a one-file desktop instrument. Its pre-registered cosmic-time bars fail and the face says so: this is a clock OF the relations in one catalogue, not a clock of the universe's age. What it reads that survives its controls: most of the whole's accumulated time lives BETWEEN the things rather than inside any of them - roughly 74%, a share that later proved direction-independent.
...
- **[59] A second level of time cannot be resolved on this catalogue: at nine level-2 frames the statistic's own calibration is wider than it claims** `[foundations]` — rung 2, 2026-08-12  
...
- **[53] Hodos Chronos rebuilt: four of five pre-registered bars clear, and the obstruction that stopped thirteen attempts was an artifact of our own estimator** `[foundations]` — rung 2, 2026-08-09  
...
- **[56] RETRACTED: 'the whole converts' - the result described a catalogue that no longer existed, and does not reproduce on the current one** `[foundations]` — rung 3, 2026-08-11  
